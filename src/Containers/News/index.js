    ...
    <ImageBackground
      ...
      <ScrollView>
        ...
        <View style={NewsStyles.newsContent}>
          <TouchableOpacity style={NewsStyles.subTitle} onPress={() => setShowTag(0)}>
          ...
          {
            showTag === 0 && <View style={NewsStyles.subContent}>
          ...
          <TouchableOpacity style={NewsStyles.subTitle} onPress={() => setShowTag(1)}>
          ...
          {
            showTag === 1 && <View style={NewsStyles.subContent}>
          ...
          <TouchableOpacity style={NewsStyles.subTitle} onPress={() => setShowTag(2)}>
          ...
          {
            showTag === 2 && <View style={NewsStyles.subContent}>
              <View style={{padding: 8, flexDirection: 'row'}}>
                <Image source={{uri: 'https://hatake.s3-ap-northeast-1.amazonaws.com/web-game/images/images/ui/em/em01.gif'}} style={{width: 14, height: 14}} />
